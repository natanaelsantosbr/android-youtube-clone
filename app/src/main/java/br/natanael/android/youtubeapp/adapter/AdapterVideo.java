package br.natanael.android.youtubeapp.adapter;
...
public class AdapterVideo extends RecyclerView.Adapter<AdapterVideo.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_video, null, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Picasso.get().load(video.snippet.thumbnails.high.url).into(holder.capa);
    }
